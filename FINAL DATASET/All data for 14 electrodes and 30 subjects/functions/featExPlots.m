...
nVals = 5;      % how many random sessions did we take? (1 means we took the feature of one signal)
...
title('Band Power Desnity in Probe Signals for Different Frequency Bands')
grid on
grid minor
