...
class curiosity(object):
    ...
    def deal_with_event_stimulation(self, events_):
        ...
        mask_stimu_to_keep, kept_stimu, list_labels, list_grades = self.select_stimulation(vector_stimu)
    ...
    def select_stimulation(self, vector_stimu):
        '''
        ...
        for stimu in vector_stimu :
            ...
            if stimu_n+2<=nb_stimu:
                if np.isin(stimu, list_keyboard_command) and (kept_stimu[-1] == 33044 or vector_stimu[stimu_n+1] == 33044 or vector_stimu[stimu_n+2] == 33044) and len(list_grades_single_question)<1:
                    list_grades.append(self.assign_grade(stimu))
                    list_grades_single_question.append(self.assign_grade(stimu))
